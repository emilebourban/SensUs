...
#TODO my tests start here                    
                    
                    num_channels = image_result.GetNumChannels()
                    if num_channels > 1:
                        image_result_data = image_result.GetData().reshape(height,width,num_channels)
                    else:
                        image_result_data = image_result.GetData().reshape(height,width)
                    
                    import matplotlib.pyplot as plt
                    print('the TYPE of the image is ', type(image_result_data))
                    plt.imshow(image_result_data)
                    plt.show()

#TODO my tests end here
